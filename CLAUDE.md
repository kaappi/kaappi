...
Of the 208 final SRFIs in the registry, 150 are implemented, 37 are tracked for
future implementation (issues #1694–#1705 minus what Phases 1–3 closed and
#1729, which completed SRFI 181's transcoded-port half — custom ports landed
separately in Phase 3, #1727), and 20 are excluded — see
