...
Of the 208 final SRFIs in the registry, 174 are implemented, 4 are tracked
for future implementation (72, 148, 211, 213 — issue #1699, "Implement
SRFI macro & syntax extension libraries": all 4 need expander or compiler
changes, e.g. 72's explicit-renaming macros, 148's eager macro
transformers, which need 147's own mechanism to build on; 139 and 149,
...
changes at all and shipped directly, while 147 (custom macro
transformers) DID need one — see below for all three), and 30 are
excluded —
