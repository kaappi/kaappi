...
Of the 208 final SRFIs in the registry, 149 are implemented, 39 are tracked for
future implementation (issues #1694–#1705 minus what Phase 3 closed, across
Phase 4 and the one Phase-3 SRFI carried forward on its own — SRFI 181, custom
ports, deferred to #1727 given its disproportionate size next to the rest of
that phase — Phase 1 and Phase 2 are both complete), and 20 are excluded — see
