...
Of the 208 final SRFIs in the registry, 173 are implemented, 5 are tracked
for future implementation (72, 147, 148, 211, 213 — issue #1699,
"Implement SRFI macro & syntax extension libraries": all 5 need expander
or compiler changes, e.g. 72's explicit-renaming macros, 147/148's
custom/eager macro transformers; 139 and 149, originally grouped here for
their syntax-parameter and syntax-rules-template-extension mechanisms
respectively, both turned out to need no engine changes at all and
shipped directly — see below), and 30 are excluded —
