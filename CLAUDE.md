...
Of the 208 final SRFIs in the registry, 139 are implemented, 51 are tracked for
future implementation (issues #1694–#1705, across the two remaining milestones,
Phase 3 and Phase 4, by difficulty — Phase 1 and Phase 2 are both complete),
and 18 are excluded — see `docs/dev/srfi-exclusions.md` for the
...
and 2 SRFIs — 206 and 212 — whose own spec text states a portable
syntax-rules-only implementation isn't possible).
