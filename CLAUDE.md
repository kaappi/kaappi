...
Of the 208 final SRFIs in the registry, 172 are implemented, 6 are tracked
for future implementation (72, 147, 148, 149, 211, 213 — issue #1699,
"Implement SRFI macro & syntax extension libraries": all 6 need expander
or compiler changes, e.g. 72's explicit-renaming macros, 147/148's
custom/eager macro transformers, 149's syntax-rules template extensions;
139, originally grouped here for its syntax-parameter mechanism, turned
out to need no engine changes at all and shipped directly — see below),
and 30 are excluded —
