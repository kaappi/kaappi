...
181 SRFIs supported: 12 built-in as Zig primitives (1, 9, 13, 18, 39, 69, 133,
170, 192, 254, 258, 260), 165 portable `.sld` files under `lib/srfi/` loaded on
...
reports only the 12 + 165, since it scans just the top-level `lib/srfi/N.sld`
