...
Of the 208 final SRFIs in the registry, 167 are implemented, 13 are tracked for
future implementation (issue #1694's array-family remainder — 25, 47, 58, 63,
164, 179, 231, all multi-dimensional-array SRFIs spanning three mutually
incompatible API lineages per their own spec text (25 vs. 47/63's conflicting
`array-set!`/`make-array` shape models; 164 explicitly rejects the interval
abstraction 179/231 build on); #1694's vector-family subset — 4 (already
