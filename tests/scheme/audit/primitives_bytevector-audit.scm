...
(test 'caught (guard (e (#t 'caught)) (utf8->string (bytevector #xCE))))          ; truncated
;; validation applies to the selected range only
(test 'caught (guard (e (#t 'caught)) (utf8->string #u8(#x41 #xFF #x42) 1 2)))
(test "A" (utf8->string #u8(#xFF #x41) 1))
(test 'caught (guard (e (#t 'caught)) (utf8->string #u8(#x41 #xCE #xBB) 0 2)))    ; range splits λ
