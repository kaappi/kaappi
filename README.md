...
— 717 built-in procedures, 32 syntax forms, and all 16 standard libraries — plus
180 SRFIs, a C FFI, OS threads and fibers, an LLVM native-code backend, a package
...
180 SRFIs are supported. Some built-in SRFIs have minor coverage gaps (e.g.,
