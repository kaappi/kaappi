...
;;;
;;; A `match` construct with non-linear patterns (a pattern variable may
;;; appear more than once and must match equal? values) and backtracking
;;; via (=> next) / (=> next back) clause guards. Nearly every pattern is
