...
Kaappi implements every identifier from [R7RS Appendix A](https://small.r7rs.org/) — 689 built-in procedures, 32 syntax forms, and all 14 standard libraries. R7RS test suite: 1,395 pass, 0 fail.
