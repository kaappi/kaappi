    ...
    "Benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "14bce50274d05c91535869f5eee6aa39d130c9c1",
          "message": "Release v0.26.1\n\nTwo numeric-tower conformance changes. (sqrt -4) now returns the exact +2i\nrather than +2.0i for negative exact perfect squares, so (eqv? (sqrt -1) +i)\nholds and (* (sqrt -1) (sqrt -1)) is -1. And sqrt is no longer exported from\n(scheme base) -- R7RS puts it in (scheme inexact), and the stray tag made a\nuser library that exports its own sqrt fail to load alongside (scheme base)\nunder 5.2 enforcement. Breaking for import selectors naming sqrt out of\n(scheme base); plain calls still resolve through the globals map. Full notes\nin CHANGELOG.md.\n\nProcedure count unchanged at 717; SRFI count unchanged at 180.\n\nCo-Authored-By: Claude Opus 5 <noreply@anthropic.com>\nSigned-off-by: Baiju Muthukadan <baiju.m.mail@gmail.com>",
          "timestamp": "2026-09-04T03:53:09+05:30",
          "tree_id": "59889fca21b283f5a65b56e3aaf45ebd0fec4a82",
          "url": "https://github.com/kaappi/kaappi/commit/14bce50274d05c91535869f5eee6aa39d130c9c1"
        },
        "date": 1788476847168,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "21297ad144bef0c97fdd22bf4db3e938e76f348c",
          "message": "Release v0.27.0\n\nAdds SRFI 277 (cyclic ports) and SRFI 4's homogeneous-vector literal\nsyntax; fixes SRFI 231's call/cc safety for every accumulating non-!\nprocedure, the c64/c128 storage-class checkers, and the unjoined-thread\nresource leak at process exit.\n\nRefreshes the built-in procedure count 717 -> 719 (the two SRFI 277 raw\nconstructors; nothing removed) and corrects CONFORMANCE.md's SRFI counts\nto 181 / 165 portable, which #2546 had left at 180 / 164 -- the site's\nupdate-wasm workflow reads those four figures from CONFORMANCE.md at the\ntag, so the stale line would have shipped to kaappi-lang.org.\n\nCo-Authored-By: Claude Opus 5 <noreply@anthropic.com>\nSigned-off-by: Baiju Muthukadan <baiju.m.mail@gmail.com>",
          "timestamp": "2026-09-08T14:20:55+05:30",
          "tree_id": "77fdcb8c378e7a6dd11e3f85a173fd6bc5cbeb2c",
          "url": "https://github.com/kaappi/kaappi/commit/21297ad144bef0c97fdd22bf4db3e938e76f348c"
        },
        "date": 1788861927358,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "dfec25470c393d6cb7308dad868420d145c4cbce",
          "message": "Archive older changelog series into changelog/ and cap entry length (#2578)\n\nCHANGELOG.md had reached 300 KB and 4,700 lines after three months of\nreleases — 46 sections, the largest 41 KB. The driver was not age but\nverbosity: each entry was a 5–10 line paragraph restating the commit\nbody's \"why\", roughly 800 bytes apiece, so every release added 10–40 KB.\n\nTwo changes, so the file shrinks now and stays small:\n\n- Every minor series before the current one (0.1 through 0.26) moves,\n  byte for byte, into changelog/<major>.<minor>.md, one file per series,\n  and the CHANGELOG.md intro links them. Only 0.27.x remains in the file.\n  Nothing else read the old sections from CHANGELOG.md: the release\n  workflow extracts just the section being released, and no README, docs\n  site, or wiki page links a changelog anchor. Each released version's\n  notes also already live on its GitHub Release page.\n\n- /github-release Step 3 now writes one line per change and, when X.Y.0\n  opens a new series, moves the previous one to the archive as part of\n  the release. The rationale stays in the commit body and PR, which is\n  where the project already says it belongs.\n\nSigned-off-by: Baiju Muthukadan <baiju.m.mail@gmail.com>\nCo-authored-by: Claude Fable 5.1 <noreply@anthropic.com>",
          "timestamp": "2026-09-14T10:40:55+05:30",
          "tree_id": "1fe3ab70af9c59eb67714f330d26f3a1c46f49ed",
          "url": "https://github.com/kaappi/kaappi/commit/dfec25470c393d6cb7308dad868420d145c4cbce"
        },
        "date": 1789363102722,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d4c8bf8dcdea4da3066b6a53636d056d4da89774",
          "message": "Move the SRFI 147/150 investigations to postmortems; drop the BSD future-work lists (#2580)\n\nSecond half of the docs/dev pass (the first was #2579). Two of the\nindex's own rules were being broken by its largest and its newest\ndocuments.\n\nsrfi-implementation-notes.md is meant to be read before editing a SRFI\nlibrary, but its two biggest sections were 170-line investigation\nnarratives: SRFI 147's seven fix-and-review rounds, and SRFI 150's two\nrejected designs plus two \"engine bugs\" that were not. That is postmortem\nmaterial, and it buried the rules a contributor actually needs. Each\nsection is now a ~50-line implementation note stating the rules and why\nthey hold, and the narratives are two dated postmortems with a lessons\nsection each, indexed in README.md and summarized as lessons-learned 16\nand 17 (once-per-object processing gated on the object; hygienic identity\ndoes not survive quote). The \"Coverage, closed issue groups\" section and\nthe \"macro & syntax extension group\" grouping heading are gone: the\ncounts duplicated \"What ships\" and srfi-exclusions.md (and had drifted),\nand the rest was closed-issue history the tracker already holds. The\nSRFI 150 note moves next to its SRFI 131/57 siblings and \"Library\nloader\" to the end, so every per-SRFI note sits under one heading. The\nfile drops from 1851 to 1595 lines.\n\nThe three BSD docs each ended in a \"Known gaps\" list, which the README\nsays belongs in the tracker because such lists rot. Every item was\neither already stated in the doc's own section (BTCFI, the LSP stack cap,\npkgsrc clang) or a fact about the testing model, not a gap: no box and\nno CI leg has a Zig toolchain, so a native zig build on the BSDs is\nuntested by design. That fact now lives in each \"Testing on\" section,\nand the versioned-symbol re-audit rule joins the NetBSD section it\nbelongs to. windows.md keeps its list, since every entry there cites an\nopen issue.\n\nunderstanding-map.md's status had read \"awaiting the maintainer's\ncorrection pass\" since July. It now states the map's provenance and\nthat a wrong tier is fixed in place, without an open item nobody owns.\n\nSigned-off-by: Baiju Muthukadan <baiju.m.mail@gmail.com>\nCo-authored-by: Claude Fable 5.1 <noreply@anthropic.com>",
          "timestamp": "2026-09-14T11:04:30+05:30",
          "tree_id": "edb2718dc9cb068969c5ec5f5ee8c9edec714be2",
          "url": "https://github.com/kaappi/kaappi/commit/d4c8bf8dcdea4da3066b6a53636d056d4da89774"
        },
        "date": 1789364508570,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "34d6e21332a94fec7fef40dca1da9ca0c374ef95",
          "message": "Add docs/dev/reader.md: the datum reader; refresh the r7rs-reader skill (#2584)\n\nKEP-0019's implementation plan asked for a reader.md covering the\ngrammar, the SRFI set, datum-label patching and spans, seeded from its\nreference section. Nothing in the repo described the reader as a whole:\nobserving-the-pipeline.md shows its output, fmt.md explains why the\nformatter needs a second one, and the rules that matter when touching a\nscanner — that every proper prefix of a datum must report UnexpectedEof\nin incomplete-input mode, that the numeric tower and not the reader\nbuilds number values, that only pairs and vectors get spans, that a\ndatum walker is not done until it survives #0=(a . #0#) — lived in\nsource comments and the issues that established them.\n\nWritten from the source at this commit and checked against it: every\nnamed function, constant and test suite exists, the KP1001–KP1010 order\nmatches readErrorCode, and the claims about which paths persist\nfold-case, mark literals immutable, and rewind a cyclic port were read\nat their sites.\n\nThe /r7rs-reader skill still listed floating point, number prefixes,\nrationals, bytevectors, datum labels and fold-case as \"not yet\nimplemented\" and vector literals as a TODO — all shipped long ago — so\na session invoking it was briefed against a reader that no longer\nexists. It is rewritten as the R7RS checklist it was meant to be, with\nthe one incomplete-input rule a new scanner must follow, and points at\nreader.md for the mechanism.\n\nREADME.md, docs/dev/CLAUDE.md and architecture.md gain pointers.\n\nSigned-off-by: Baiju Muthukadan <baiju.m.mail@gmail.com>\nCo-authored-by: Claude Fable 5.1 <noreply@anthropic.com>",
          "timestamp": "2026-09-14T11:51:43+05:30",
          "tree_id": "bb8bb0ae2d178b6005b9a6ca9c365b8e6c2d552a",
          "url": "https://github.com/kaappi/kaappi/commit/34d6e21332a94fec7fef40dca1da9ca0c374ef95"
        },
        "date": 1789367328799,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "3e90b30a8854a38aa857fd4fb0c7c8c71d1dc599",
          "message": "architecture.md: refresh the reader file line counts (#2585)\n\nKEP-0019's plan step 2 asked for this alongside reader.md (kaappi#2584):\nthe table said ~1000/~975/~360 for reader.zig, reader_tokens.zig and\nreader_datum.zig; they are 1258, 1470 and 462 at this commit.\n\nSigned-off-by: Baiju Muthukadan <baiju.m.mail@gmail.com>\nCo-authored-by: Claude Fable 5.1 <noreply@anthropic.com>",
          "timestamp": "2026-09-14T11:54:22+05:30",
          "tree_id": "2c6c3ff070510c4065e91a53d7990f03eda877a7",
          "url": "https://github.com/kaappi/kaappi/commit/3e90b30a8854a38aa857fd4fb0c7c8c71d1dc599"
        },
        "date": 1789367518013,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "7efe46811534a1311bd3a8c887bc71f0d7c87d83",
          "message": "Split the SRFI 231 and 211 notes into rules plus postmortems (#2589)\n\nThe same treatment the SRFI 147 and 150 sections got in #2580.\nsrfi-implementation-notes.md is read before editing a SRFI library, and\nits SRFI 231 section had become a 151-line account of three weeks of\ncorrespondence with the SRFI's author — the call/cc re-entry defect, the\nc64/c128 checker that was filed, fixed and reverted, the \"reference\nimplementation\" terminology we had invented a rule around — with the\nrules a contributor needs buried inside. It was also stale: it still\ndescribed specialized-array-reshape as a packed-only shortcut, which the\n2026-08-26 anomaly batch replaced with NumPy's _attempt_nocopy_reshape.\n\nThe 231 section is now an 80-line note: representation, the seven rules\nto keep (lazy build through array-copy, threaded accumulators, the\nNumPy reshape, absolute coordinates, two-phase array-block, prose over\nsample code, the permanent c64/c128 divergence), and pointers. The two\nincidents become dated postmortems with lessons, indexed in README.md\nand summarized as lessons-learned 18 and 19: a single re-entry proves\nnothing about continuation safety, and a sample implementation is a\nsecond opinion, not the specification.\n\nThe 211 section was mechanism, not narrative, and that mechanism now\nlives in expander.md and KEP-0006's as-implemented record; it also\ncarried a broken paste (\"A bare-symbol ... reaches the expansion\" with\nits subject lost). It is now a 67-line note of what is specific to the\nlibraries — the sub-library-only surface and why, the whole-def_env copy\nat import, capture-lookup as identity, define-property's table, the\nfour-quadrant compare guarantee and its pinned boundary, the circular\nrename rejection — with the engine delegated to expander.md. The file\ndrops from 1595 to 1481 lines.\n\nSigned-off-by: Baiju Muthukadan <baiju.m.mail@gmail.com>\nCo-authored-by: Claude Fable 5.1 <noreply@anthropic.com>",
          "timestamp": "2026-09-14T12:20:05+05:30",
          "tree_id": "59db4c3fb3884c406b2c5b25e21938867928a84c",
          "url": "https://github.com/kaappi/kaappi/commit/7efe46811534a1311bd3a8c887bc71f0d7c87d83"
        },
        "date": 1789369018821,
        "tool": "customSmallerIsBetter",
        "benches": [
