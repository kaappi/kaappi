...
pub const INITIAL_HANDLER_CAPACITY = types_continuation.INITIAL_HANDLER_CAPACITY;
pub const INITIAL_WIND_CAPACITY = types_continuation.INITIAL_WIND_CAPACITY;
pub const MAX_HANDLER_LIMIT = types_continuation.MAX_HANDLER_LIMIT;
pub const MAX_WIND_LIMIT = types_continuation.MAX_WIND_LIMIT;
...
pub const INITIAL_FIBER_HANDLER_CAPACITY = types_continuation.INITIAL_FIBER_HANDLER_CAPACITY;
pub const INITIAL_FIBER_WIND_CAPACITY = types_continuation.INITIAL_FIBER_WIND_CAPACITY;
