...
// The SRFI 211 (procedural macro transformers) + SRFI 213 (identifier
// properties) engine-seam tests — including the KEP-0006 step 1 forced-GC
// rooting tests (#2390) — live in tests_macros_procedural.zig (split out to
// keep this file within the 1500-line policy).
