...
pub fn registerStandardLibraries(registry: *LibraryRegistry, globals: *std.StringHashMap(Value)) !void {
    ...
    const scheme_base_names = [_][]const u8{
        ...
        // Pairs and lists
                         "cons",                          "car",
        "cdr",                            "set-car!",              "set-cdr!",                      "list",
        "length",                         "append",                "reverse",                       "caar",
        "cadr",                           "cdar",                  "cddr",                          "list-ref",
        "list-tail",                      "list-set!",             "list-copy",                     "make-list",
        "member",                         "memq",                  "memv",                          "assoc",
        "assq",                           "assv",
        // Higher-order list functions
                         "map",                           "for-each",
        // Type predicates
        "pair?",                          "null?",                 "number?",                       "integer?",
        "real?",                          "complex?",              "rational?",                     "symbol?",
        "string?",                        "boolean?",              "char?",                         "procedure?",
        "list?",
        // Equivalence
                                 "eq?",                   "eqv?",                          "equal?",
        // Boolean
        ...
        // String operations
                             "number->string",
        "string->number",                 "string-length",         "string-append",                 "symbol->string",
        "string->symbol",                 "string",                "make-string",                   "string-ref",
        "string-set!",                    "substring",             "string-copy",                   "string-copy!",
        "string-fill!",                   "string->list",          "list->string",                  "string-for-each",
        ...
        "with-exception-handler",         "error-object?",         "error-object-message",          "error-object-irritants",
        "file-error?",                    "read-error?",
        // Record system internal primitives (used by define-record-type)
                  "%make-record-type",             "%make-record",
        "%record?",                       "%record-ref",           "%record-set!",
        // Port and I/O (R7RS 6.13)
                         "current-input-port",
        "current-output-port",            "current-error-port",    "port?",                         "input-port?",
        "output-port?",                   "textual-port?",         "binary-port?",                  "input-port-open?",
        "output-port-open?",              "close-port",            "close-input-port",              "close-output-port",
        "read-char",                      "peek-char",             "read-line",                     "char-ready?",
        "write-char",                     "write-string",          "eof-object?",                   "eof-object",
        // Continuations (R7RS 6.10)
        "call-with-current-continuation", "call/cc",               "call-with-escape-continuation", "call/ec",
        ...
        "list->vector",                   "vector-fill!",          "vector-copy",                   "vector-copy!",
        "vector-append",                  "vector-for-each",       "vector-map",                    "vector->string",
    ...
    const srfi1_names = [_][]const u8{
        ...
        "filter",       "remove",            "partition",         "find",
        "find-tail",    "any",               "every",             "count",
        "iota",         "zip",               "concatenate",       "take",
        "drop",         "take-while",        "drop-while",        "filter-map",
        "append-map",   "last",              "last-pair",         "proper-list?",
        "dotted-list?", "circular-list?",    "lset-intersection", "lset-difference",
        "lset=",        "lset-adjoin",       "lset-union",        "lset-xor",
        "xcons",        "cons*",             "list-tabulate",     "circular-list",
        "not-pair?",    "null-list?",        "list=",             "first",
        "second",       "third",             "fourth",            "fifth",
        "sixth",        "seventh",           "eighth",            "ninth",
        "tenth",        "car+cdr",           "take-right",        "drop-right",
        "split-at",     "list-index",        "span",              "break",
        "delete",       "delete-duplicates", "alist-cons",        "alist-copy",
        "alist-delete", "unfold",            "unfold-right",      "append-reverse",
        "length+",      "unzip1",            "unzip2",            "pair-for-each",
        "pair-fold",    "pair-fold-right",   "map-in-order",
    };
    ...
    const srfi133_names = [_][]const u8{
        ...
        "vector-for-each",     "vector-map",        "vector-empty?",       "vector-count",
...
pub fn registerSandboxedLibraries(registry: *LibraryRegistry, globals: *std.StringHashMap(Value)) !void {
    ...
    const scheme_base_names = [_][]const u8{
        ...
        "square",                         "sqrt",                  "cons",                          "car",
        "cdr",                            "set-car!",              "set-cdr!",                      "list",
        "length",                         "append",                "reverse",                       "caar",
        "cadr",                           "cdar",                  "cddr",                          "list-ref",
        "list-tail",                      "list-set!",             "list-copy",                     "make-list",
        "member",                         "memq",                  "memv",                          "assoc",
        "assq",                           "assv",                  "map",                           "for-each",
        "pair?",                          "null?",                 "number?",                       "integer?",
        "real?",                          "complex?",              "rational?",                     "symbol?",
        "string?",                        "boolean?",              "char?",                         "procedure?",
        "list?",                          "eq?",                   "eqv?",                          "equal?",
        "not",                            "boolean=?",             "symbol=?",                      "number->string",
        "string->number",                 "string-length",         "string-append",                 "symbol->string",
        "string->symbol",                 "string",                "make-string",                   "string-ref",
        "string-set!",                    "substring",             "string-copy",                   "string-copy!",
        "string-fill!",                   "string->list",          "list->string",                  "string-for-each",
        "string-map",                     "string<?",              "string<=?",                     "string=?",
        "string>=?",                      "string>?",              "char->integer",                 "integer->char",
        "char<?",                         "char<=?",               "char=?",                        "char>=?",
        "char>?",                         "display",               "write",                         "newline",
        "apply",                          "error",                 "raise",                         "raise-continuable",
        "with-exception-handler",         "error-object?",         "error-object-message",          "error-object-irritants",
        "file-error?",                    "read-error?",           "%make-record-type",             "%make-record",
        "%record?",                       "%record-ref",           "%record-set!",                  "current-input-port",
        "current-output-port",            "current-error-port",    "port?",                         "input-port?",
        "output-port?",                   "textual-port?",         "binary-port?",                  "input-port-open?",
        "output-port-open?",              "close-port",            "close-input-port",              "close-output-port",
        "read-char",                      "peek-char",             "read-line",                     "char-ready?",
        "write-char",                     "write-string",          "eof-object?",                   "eof-object",
        "call-with-current-continuation", "call/cc",               "call-with-escape-continuation", "call/ec",
        "dynamic-wind",                   "values",                "call-with-values",              "make-rectangular",
        "make-polar",                     "real-part",             "imag-part",                     "magnitude",
        "angle",                          "vector",                "make-vector",                   "vector?",
        "vector-length",                  "vector-ref",            "vector-set!",                   "vector->list",
        "list->vector",                   "vector-fill!",          "vector-copy",                   "vector-copy!",
        "vector-append",                  "vector-for-each",       "vector-map",                    "vector->string",
        "bytevector?",                    "make-bytevector",       "bytevector",                    "bytevector-length",
        "bytevector-u8-ref",              "bytevector-u8-set!",    "bytevector-copy",               "bytevector-copy!",
        "bytevector-append",              "utf8->string",          "string->utf8",                  "open-input-string",
        "open-output-string",             "get-output-string",     "read-string",                   "flush-output-port",
        "floor-quotient",                 "floor-remainder",       "floor/",                        "truncate-quotient",
        "truncate-remainder",             "truncate/",             "numerator",                     "denominator",
        "rationalize",                    "exact->inexact",        "inexact->exact",                "features",
        "string->symbol",                 "make-promise",          "promise?",                      "make-parameter",
