...
pub fn registerStandardLibraries(registry: *LibraryRegistry, globals: *std.StringHashMap(Value)) !void {
    ...
    const scheme_base_names = [_][]const u8{
        ...
        // Binary I/O
                        "read-u8",               "peek-u8",
        "u8-ready?",              "write-u8",                       "read-bytevector",       "write-bytevector",
        // Bytevector ports
        "open-input-bytevector",  "open-output-bytevector",         "get-output-bytevector", "read-bytevector!",
...
pub fn registerSandboxedLibraries(registry: *LibraryRegistry, globals: *std.StringHashMap(Value)) !void {
    ...
    const scheme_base_names = [_][]const u8{
        ...
        "features",               "string->symbol",                 "make-promise",          "promise?",
        "make-parameter",         "call-with-port",                 "read-u8",               "peek-u8",
        "u8-ready?",              "write-u8",                       "read-bytevector",       "write-bytevector",
        "open-input-bytevector",  "open-output-bytevector",         "get-output-bytevector", "read-bytevector!",
        "string->vector",
    };
